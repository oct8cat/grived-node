...
/**
 * Checks if Google Drive API is accessible with the given access token.
 * @param {string} accessToken Access token.
 * @param {callbacks~ErrorObjectCallback} cb Callback.
 */
Grived.prototype.checkAccess = function(accessToken, cb) {
    drive.files.list({access_token: accessToken, maxResults: 0}, cb)
}
